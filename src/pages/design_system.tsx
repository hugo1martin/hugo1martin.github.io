...
function DesignSystem() {
  return (
    <Layout>
      <div className="flex column h-space-2">
        <h1>Heading 1</h1>
        <h2>Heading 2</h2>
        <h3>Heading 3</h3>

        <div className="flex column">
          <button className="button default bottom-space-2">Default</button>
          <button className="button primary bottom-space-2">Primary</button>
          <button className="button secondary bottom-space-2">Secondary</button>
          <button className="button primary-inverse bottom-space-2">
            Primary Inverse
          </button>
          <button className="button secondary-inverse bottom-space-2">
            Secondary Inverse
          </button>
          <button className="button default-inverse bottom-space-2">
            Default inverse
          </button>
          <button className="button default-no-border bottom-space-2">
            Default No Border
          </button>
